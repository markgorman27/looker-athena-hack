view: fact_metrics_agg_district {
  sql_table_name: metrics_wba_dev.fact_metrics_agg_district ;;

  dimension: primary_key {
    primary_key: yes
    type: string
    hidden: yes
    sql: ${TABLE}.district_id || ${TABLE}.toperiod || ${TABLE}.computeperiod || ${TABLE}.cadence ||${TABLE}.period_comparison ;;
  }
