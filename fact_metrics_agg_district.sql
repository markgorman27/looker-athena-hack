CREATE EXTERNAL TABLE IF NOT EXISTS metrics_wba_dev.fact_metrics_agg_district (
	  `toperiod` date,
	...
	partitioned by (district_id string)
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe'
	WITH SERDEPROPERTIES (
		  'serialization.format' = ',',
		  'field.delim' = ','
	) LOCATION 's3://metrics-wba-dev/fact_metrics_agg_district/'
