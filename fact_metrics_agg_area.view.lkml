view: fact_metrics_agg_area {
  sql_table_name: metrics_wba_dev.fact_metrics_agg_area ;;

  dimension: primary_key {
    primary_key: yes
    type: string
    hidden: yes
    sql: ${TABLE}.area_id || ${TABLE}.toperiod || ${TABLE}.computeperiod || ${TABLE}.cadence ||${TABLE}.period_comparison ;;
  }
